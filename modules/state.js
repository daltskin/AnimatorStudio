...
const DEFAULT_STAGE_WIDTH = canvas ? Number(canvas.getAttribute("width")) || 1440 : 1440;
const DEFAULT_STAGE_HEIGHT = canvas ? Number(canvas.getAttribute("height")) || 900 : 900;
